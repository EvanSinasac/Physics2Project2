...
bool cVAOManager::LoadPLYModelFromFile(std::string fileName, sModelDrawInfo& drawInfo)
{
    ...
    for (unsigned int index = 0; index < drawInfo.numberOfVertices; index++)
    {
        ...
        //::g_debugNormals[index].push_back(glm::vec3(tempVertex.x, tempVertex.y, tempVertex.z));
        ...
        //::g_debugNormals[index].push_back(glm::vec3(tempVertex.nx, tempVertex.ny, tempVertex.nz));
